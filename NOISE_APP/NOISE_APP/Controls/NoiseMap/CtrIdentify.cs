...
{
    public partial class CtrIdentify : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void BindEvents()
        {
            ...
            cboLayers.EditValueChanged += (sender, e) =>
            {
                ...
                if (string.IsNullOrWhiteSpace(value))
                    identifyStatus = IdentifyStatus.None;
                ...
                if (tag is IFeature)
                {
                    ...
                    for (int i = 0; i < pFeature.Fields.FieldCount; i++)
                    {
                        ...
                        if (field.Type == ESRI.ArcGIS.Geodatabase.esriFieldType.esriFieldTypeGeometry
                            ...
                            continue;
                        mProperties.Add(new ObjectInfo(field.Name, pFeature.Value[i]?.ToString()));
                    }
                }
                else
                {
